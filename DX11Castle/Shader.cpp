...
void PixelShader::Compile( const string& source, const string& aFunction )
{
...
void GeometryShader::Compile( const string& source, const string& aFunction )
{
	ID3DBlob* pPSBlob = NULL;
...
void VertexShader::Compile( const string& source, const string& aFunction )
{
...
void Shader::CompileBlob( const string& source, const string& entry, const string& target )
{
	HRESULT hr = S_OK;
