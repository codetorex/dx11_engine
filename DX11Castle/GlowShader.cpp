...
GlowPixelShaderVPS* GlowPixelShaderVPS::Instance;
GlowPixelShaderHPS* GlowPixelShaderHPS::Instance;
GlowVertexShader* GlowVertexShader::Instance;

void GlowVertexShader::CompileInputLayout()
{
