...
ParticlePixelShader* ParticlePixelShader::Instance;
ParticleGeometryShader* ParticleGeometryShader::Instance;
ParticleVertexShader* ParticleVertexShader::Instance;

void ParticleVertexShader::CompileInputLayout()
{
